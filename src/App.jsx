...
// const AppContent = ({ isAuthenticated, currentUser, handleLogin }) => {
...
//         </Routes>
//       </div>
//       {location.pathname !== '/projects' && <Footer />} {/* Conditionally render the Footer */}
//     </>
//   );
// };
...
const AppContent = ({ isAuthenticated, currentUser, handleLogin }) => {
  ...
  // Condition to hide the Footer on specific pages
  const shouldShowFooter = location.pathname !== '/projects' && location.pathname !== '/auth';
