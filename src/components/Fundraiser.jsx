...
<div
  class="group flex flex-col shadow-lg justify-start mt-12 items-start gap-2 w-96 h-56 duration-500 relative rounded-lg p-4 bg-gray-100 hover:-translate-y-2 hover:shadow-xl shadow-gray-300"
>
  <div
