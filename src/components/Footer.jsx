...
<footer className="bg-gray-300">
  <div className="mx-8 max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
          <div>
            <h2 className="text-2xl font-bold text-primary">Get the latest news!</h2>

            <p className="mt-4 text-gray-500">
            Inscris-toi à notre newsletter pour rester informé des dernières actualités du monde vert.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            <div
              className="border border-primary p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
            >
              <input
                type="email"
                id="UserEmail"
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; 2024. EarthCare By GlodyMafo. All rights reserved.</p>
